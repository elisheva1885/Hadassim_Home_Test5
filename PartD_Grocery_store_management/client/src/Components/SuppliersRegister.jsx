                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="p-fluid">
                        <div className="field">
                            <span className="p-float-label">
                                <Controller name="companyName" control={control} rules={{ required: 'companyName is required.' }} render={({ field, fieldState }) => (
                                    <InputText id={field.companyName} {...field} autoFocus className={classNames({ 'p-invalid': fieldState.invalid })} />
                                )} />
                                <label htmlFor="companyName" className={classNames({ 'p-error': errors.name })}>companyName*</label>
                            </span>
                            ...
                            <span className="p-float-label p-input-icon-right">
                                ...
                                <Controller name="phoneNumber" control={control} rules={{ required: 'phoneNumber is required.' }}
                                    render={({ field, fieldState }) => (
                                        <InputText id={field.phoneNumber} {...field} className={classNames({ 'p-invalid': fieldState.invalid })} />
                                    )} />
                                <label htmlFor="phoneNumber" className={classNames({ 'p-error': !!errors.email })}>phoneNumber*</label>
                            </span>
                        ...
                        <div className="field">
                            <span className="p-float-label">
                                ...
                                <label htmlFor="representative_Name">representative_Name</label>
                            </span>
